...
#######################
# Load Design and AIP #
analyze -sv12 +define+DEFAULT_UPPERBOUND=1 ../../rtl/counter.sv

analyze -sv12 +define+DEFAULT_UPPERBOUND=1 +incdir+../../rtl ../../properties/fv_counter.sv
analyze -sv12 +define+DEFAULT_UPPERBOUND=1 +incdir+../../rtl ../../properties/fv_constraints.sv
analyze -sv12 +define+DEFAULT_UPPERBOUND=1 +incdir+../../rtl ../../properties/fv_scenarios.sv
analyze -sv12 +define+DEFAULT_UPPERBOUND=1 +incdir+../../rtl ../../properties/fv_top_aip.sv
