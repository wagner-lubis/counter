...
analyze -format sverilog -vcs " +incdir+$design_path +define+DEFAULT_UPPERBOUND=1 " [subst {
...
analyze -format sverilog -vcs " -assert svaext +incdir+$design_path +define+DEFAULT_UPPERBOUND=1 " [subst {
...
elaborate customer_counter -vcs "-pvalue+WIDTH=4 " -verbose -sva
